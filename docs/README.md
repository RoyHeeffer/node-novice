...
Per cursus-sectie passen we de nieuw opgedane kennis steeds toe in een project dat we langzaam uitbouwen tot een volwaardige applicatie. Na het voltooien van de volledige cursus wordt er een assessment afgenomen om te beoordelen of je de geleerde concepten volledig begrijpt en kunt toepassen.
